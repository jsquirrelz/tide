...
func phaseSpec(t *testing.T, milestoneRef string) runtime.RawExtension {
	t.Helper()
	raw, err := json.Marshal(tidev1alpha1.PhaseSpec{MilestoneRef: milestoneRef})
	if err != nil {
...
func TestRunHappyPath(t *testing.T) {
	...
	milestone := &tidev1alpha1.Milestone{
...
func TestRunIdempotent(t *testing.T) {
	...
	existingPhase := &tidev1alpha1.Phase{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "pre-existing-phase-idem",
			Namespace: parentNS,
		},
		Spec: tidev1alpha1.PhaseSpec{MilestoneRef: parentName},
	}
...
func TestRunMissingOutJSON(t *testing.T) {
	...
	c := buildFakeClient(t, &tidev1alpha1.Milestone{
...
func TestRunDisallowedKind(t *testing.T) {
	...
	var phases tidev1alpha1.PhaseList
