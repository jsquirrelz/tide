...
var _ = Describe("Planner Job absent while Running (debug real-claude-authoring-path)", Label("envtest", "phase3"), func() {
	...
	makeProject := func(name string) *tideprojectv1alpha3.Project {
		proj := &tideprojectv1alpha3.Project{
			...
			Spec: tideprojectv1alpha3.ProjectSpec{SchemaRevision: "v1alpha3",
				...
				Gates: tideprojectv1alpha3.Gates{Milestone: "auto", Phase: "auto"},
			},
		}
	...
	It("Project: succession fires when the project planner Job is gone while Running", func() {
		...
		DeferCleanup(func() {
			cleanup(&tideprojectv1alpha3.Project{}, projectName)
			deleteAllJobs()
		})
		...
		got.Status.Phase = tideprojectv1alpha3.PhaseRunning
		...
		Eventually(func(g Gomega) {
			...
			g.Expect(p.Status.Phase).To(Equal(tideprojectv1alpha3.PhaseRunning))
		}, "5s", "100ms").Should(Succeed())
	...
	It("Milestone: succession fires when the milestone planner Job is gone while Running", func() {
		...
		DeferCleanup(func() {
			cleanup(&tideprojectv1alpha3.Milestone{}, milestoneName)
			cleanup(&tideprojectv1alpha3.Project{}, projectName)
			deleteAllJobs()
		})
	...
	It("Phase: succession fires when the phase planner Job is gone while Running", func() {
		...
		DeferCleanup(func() {
			cleanup(&tideprojectv1alpha3.Phase{}, phaseName)
			cleanup(&tideprojectv1alpha3.Milestone{}, milestoneName)
			cleanup(&tideprojectv1alpha3.Project{}, projectName)
			deleteAllJobs()
		})
	...
	It("Milestone: succeeds (not fails) when planner Job AND envelope are absent but child Phase Succeeded", func() {
		...
		waitForCacheSync(milestoneName, "default", &tideprojectv1alpha3.Milestone{})
		DeferCleanup(func() {
			cleanup(&tideprojectv1alpha3.Phase{}, "child-phase-envabsent")
			cleanup(&tideprojectv1alpha3.Milestone{}, milestoneName)
			cleanup(&tideprojectv1alpha3.Project{}, projectName)
			deleteAllJobs()
		})
		...
		waitForCacheSync("child-phase-envabsent", "default", &tideprojectv1alpha3.Phase{})
		var cp tideprojectv1alpha3.Phase
	...
	It("Phase: succeeds (not fails) when planner Job AND envelope are absent but child Plan Succeeded", func() {
		...
		waitForCacheSync(phaseName, "default", &tideprojectv1alpha3.Phase{})
		DeferCleanup(func() {
			cleanup(&tideprojectv1alpha3.Plan{}, "child-plan-envabsent")
			cleanup(&tideprojectv1alpha3.Phase{}, phaseName)
			cleanup(&tideprojectv1alpha3.Milestone{}, milestoneName)
			cleanup(&tideprojectv1alpha3.Project{}, projectName)
			deleteAllJobs()
		...
		waitForCacheSync("child-plan-envabsent", "default", &tideprojectv1alpha3.Plan{})
		var cpl tideprojectv1alpha3.Plan
