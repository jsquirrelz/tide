...
func TestDefaultCaps(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			in:            &tidev1alpha3.Caps{WallClockSeconds: -1},
			kind:          JobKindExecutor,
			wantWallClock: executorCapsFloorSeconds,
		},
		{
		...
		},
		{
			...
			in:            &tidev1alpha3.Caps{WallClockSeconds: 600},
			kind:          JobKindExecutor,
			wantWallClock: 600,
		},
		{
			name:           "executor: zero WallClockSeconds + non-zero Iterations → 1200s floor, Iterations preserved",
			in:             &tidev1alpha3.Caps{WallClockSeconds: 0, Iterations: 50},
			kind:           JobKindExecutor,
			wantWallClock:  executorCapsFloorSeconds,
			wantIterations: 50,
		},
		{
			...
			in:               &tidev1alpha3.Caps{WallClockSeconds: 0, InputTokens: 100000, OutputTokens: 50000},
			kind:             JobKindExecutor,
			wantWallClock:    executorCapsFloorSeconds,
		...
		},
		{
			...
			in:             &tidev1alpha3.Caps{WallClockSeconds: 0, Iterations: 20},
			kind:           JobKindPlanner,
			wantWallClock:  plannerCapsFloorSeconds,
			wantIterations: 20,
		},
