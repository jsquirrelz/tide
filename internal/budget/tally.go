...
func RollUpUsage(ctx context.Context, c client.Client, project *tidev1alpha3.Project, usage pkgdispatch.Usage) error {
...
//
// Phase 04.1 P4.1.
func MaybeResetWindow(ctx context.Context, c client.Client, project *tidev1alpha3.Project, now time.Time) (bool, error) {
	if project == nil {
		return false, nil
	}
