...
func TestMaterializeChildCRDsHappyPath(t *testing.T) {
	...
	if err := tideprojectv1alpha3.AddToScheme(scheme); err != nil {
		t.Fatalf("AddToScheme: %v", err)
	}
	...
	phaseSpec := tideprojectv1alpha3.PhaseSpec{MilestoneRef: "parent-milestone"}
...
func TestMaterializeChildCRDsIdempotent(t *testing.T) {
	...
	existing := &tideprojectv1alpha3.Phase{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "pre-existing-phase",
			Namespace: "default",
		},
		Spec: tideprojectv1alpha3.PhaseSpec{MilestoneRef: "parent-milestone"},
	}
...
func TestMaterializeChildCRDsTaskPromptPath(t *testing.T) {
	...
	taskSpec := tideprojectv1alpha3.TaskSpec{
		PlanRef:             "parent-plan",
...
func TestMaterializeChildCRDsStampsParentRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			parent:     &tideprojectv1alpha3.Project{ObjectMeta: metav1.ObjectMeta{UID: "proj-uid", Name: "project-01", Namespace: "default"}},
			childKind:  "Milestone",
			childName:  "milestone-01",
			rawSpec:    mustJSON(t, tideprojectv1alpha3.MilestoneSpec{ProjectRef: "project-99-wrong"}),
			wantRefOf:  func(o client.Object) string { return o.(*tideprojectv1alpha3.Milestone).Spec.ProjectRef },
			realParent: "project-01",
		},
		{
			name:       "milestone->phase",
			parent:     &tideprojectv1alpha3.Milestone{ObjectMeta: metav1.ObjectMeta{UID: "ms-uid", Name: "milestone-01-time-formatting", Namespace: "default"}},
			childKind:  "Phase",
			childName:  "phase-01",
			rawSpec:    mustJSON(t, tideprojectv1alpha3.PhaseSpec{MilestoneRef: "milestone-02-time-formatting"}),
			wantRefOf:  func(o client.Object) string { return o.(*tideprojectv1alpha3.Phase).Spec.MilestoneRef },
			realParent: "milestone-01-time-formatting",
		},
		{
			name:       "phase->plan",
			parent:     &tideprojectv1alpha3.Phase{ObjectMeta: metav1.ObjectMeta{UID: "ph-uid", Name: "phase-01", Namespace: "default"}},
			childKind:  "Plan",
			childName:  "plan-01",
			rawSpec:    mustJSON(t, tideprojectv1alpha3.PlanSpec{PhaseRef: "phase-77-wrong"}),
			wantRefOf:  func(o client.Object) string { return o.(*tideprojectv1alpha3.Plan).Spec.PhaseRef },
			realParent: "phase-01",
		},
		{
			name:       "plan->task",
			parent:     &tideprojectv1alpha3.Plan{ObjectMeta: metav1.ObjectMeta{UID: "pl-uid", Name: "plan-01", Namespace: "default"}},
			childKind:  "Task",
			childName:  "task-01",
			rawSpec:    mustJSON(t, tideprojectv1alpha3.TaskSpec{PlanRef: "plan-42-wrong", FilesTouched: []string{"main.go"}, DeclaredOutputPaths: []string{"main.go"}}),
			wantRefOf:  func(o client.Object) string { return o.(*tideprojectv1alpha3.Task).Spec.PlanRef },
			realParent: "plan-01",
		},
	}
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			switch tc.childKind {
			case "Milestone":
				got = &tideprojectv1alpha3.Milestone{}
			case "Phase":
				got = &tideprojectv1alpha3.Phase{}
			case "Plan":
				got = &tideprojectv1alpha3.Plan{}
			case "Task":
				got = &tideprojectv1alpha3.Task{}
			}
...
func TestMaterializeChildCRDsProjectParentStampsLabelAtCreateSite(t *testing.T) {
	...
	msSpec := tideprojectv1alpha3.MilestoneSpec{ProjectRef: projectName}
...
func TestMaterializeChildCRDsSharedContextIdentity(t *testing.T) {
	...
	parent := &tideprojectv1alpha3.Project{
		ObjectMeta: metav1.ObjectMeta{
	...
	msSpec := tideprojectv1alpha3.MilestoneSpec{}
	rawMS, _ := json.Marshal(msSpec)

	phSpec := tideprojectv1alpha3.PhaseSpec{MilestoneRef: "project-sc-identity"}
	rawPh, _ := json.Marshal(phSpec)

	plSpec := tideprojectv1alpha3.PlanSpec{PhaseRef: "project-sc-identity"}
	rawPl, _ := json.Marshal(plSpec)

	tkSpec := tideprojectv1alpha3.TaskSpec{PlanRef: "project-sc-identity", FilesTouched: []string{"main.go"}}
	...
	var gotPl tideprojectv1alpha3.Plan
	...
	var gotTk tideprojectv1alpha3.Task
