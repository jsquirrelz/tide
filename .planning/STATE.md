...
status: planning
last_updated: "2026-07-15T12:25:07.629Z"
...
Last activity: 2026-07-15 — Milestone v1.0.8 started
...
| 260715-4jd | Fix kind-suite namespace-Terminating recreate race — swap fire-and-forget deleteNamespace() to blocking deleteNamespaceAndWait() at 6 call sites across 5 multi-spec kind test files (push_lease, credproxy, wave, integration_miss, medium_http) whose specs share a namespace constant, so the next spec's BeforeEach can't recreate mid-termination; suite_test.go helpers untouched | 2026-07-15 | a470cda | [260715-4jd-fix-kind-suite-namespace-terminating-rec](./quick/260715-4jd-fix-kind-suite-namespace-terminating-rec/) |
| 260715-5r8 | Wire dashboard settings repo.baseRef to Spec.Git.BaseRef (Phase 37 W-1/IN-02: forward-declared stub serialized "" though the field landed in Phase 35 — settings card showed "HEAD (default)" for baseRef projects); nil-guarded for git-less projects, stale test assertion flipped, go test ./cmd/dashboard/... green | 2026-07-15 | 25a90c0 | [260715-5r8-wire-dashboard-settings-baseref-to-spec-](./quick/260715-5r8-wire-dashboard-settings-baseref-to-spec-/) |
