...
- [x] **IMPORT-04**: Import re-derives the global Execution DAG and runs cycle detection explicitly before materializing any child CRDs; cyclic or unresolved imported graphs are rejected, and Wave CRs are never imported (always re-derived).
