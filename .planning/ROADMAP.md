...
- [ ] 04-08-PLAN.md — cmd/tide annotation-writer verbs (approve/reject/cancel/resume) + tail (Wave 4)
- [ ] 04-09-PLAN.md — .goreleaser.yaml + Krew manifest + release.yaml workflow + docs/cli.md (Wave 4)
...
- [ ] 04-16-PLAN.md — PodLogStreamer + SSE hooks + ANSI parser + EmptyState/ErrorState/LoadingState + bundle-size gate + Makefile embed (Wave 9)
