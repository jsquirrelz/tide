...
Plans:
- [ ] 02.2-01-PLAN.md — Source-shape fixes (kindTestTimeout 7m, cert-manager v1.20.2, cleanupKindCluster helper, helm --replace, CI YAML DUR-check drop) + end-to-end runtime verification (Wave 1)
- [ ] 02.2-02-PLAN.md — ROADMAP/STATE closeout, gated on 02.2-01-VERIFICATION.md gate_decision=APPROVED (Wave 2)
