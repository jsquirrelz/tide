...
- [ ] 02.2-04-PLAN.md — TACTICAL: define --metrics-bind-address flag in cmd/manager — close 02.2-03 BLOCKED gate + runtime re-verification + wire Plan 02.2-02 checkpoint (gated on Task 2 APPROVED) (Wave 3)
