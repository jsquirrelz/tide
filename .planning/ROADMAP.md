...
- [ ] 04-07-PLAN.md — cmd/tide skeleton + read-only verbs (apply/watch/inspect-wave/artifact-get/describe-budget) (Wave 2)
- [ ] 04-10-PLAN.md — cmd/dashboard skeleton + chi router + Hub + projects API + zero-mutation guard (Wave 2)
...
- [ ] 04-11-PLAN.md — Dashboard SSE handlers (events + pod-log) + informer-bridge (Wave 3)
- [ ] 04-06-PLAN.md — W-1 exit-10/exit-11 split + counter + W-2 mid-stack boundary push triggers (Wave 4)
- [ ] 04-12-PLAN.md — dashboard/web scaffold + design tokens + chrome components (Wave 4)
- [ ] 04-15-PLAN.md — Status/primitive components (StatusBadge, ProjectPicker, ClipboardCopyAction, WaveBackground) (Wave 5)
- [ ] 04-13-PLAN.md — DAG views + 5 custom nodes + TaskDetailDrawer + dagre layout (Wave 6)
- [ ] 04-16-PLAN.md — PodLogStreamer + SSE hooks + ANSI parser + EmptyState/ErrorState/LoadingState + bundle-size gate + Makefile embed (Wave 7)
- [ ] 04-14-PLAN.md — Helm chart additions (dashboard-deployment + RBAC + ServiceMonitor) + E2E smoke (Wave 8)
