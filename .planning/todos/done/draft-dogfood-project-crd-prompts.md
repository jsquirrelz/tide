...
- [x] Analytics project prompt — Prometheus-backed run telemetry & cost metrics
      ...
      persistence.
- [x] Codex runtime project prompt — second `Subagent` impl in
...
- [x] Project editor prompt — dashboard authoring surface for `Project` CRs:
...
- [x] Decide run order mechanics: analytics first, editor third (see note
