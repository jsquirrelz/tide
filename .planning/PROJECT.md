...
## Last Completed Milestone: v1.0.8 — Phoenix Rising: OpenInference Trace Emission + Self-Hosted Phoenix (COMPLETE 2026-07-17 · public tag/release pending)
...
## Last Released Milestone: v1.0.7 — First-Run Paper Cuts: Run Integrity & Operator Ergonomics (SHIPPED 2026-07-15, tag `v1.0.7`) — still the last *published* release; v1.0.8 is complete but unreleased
...
## Current State (latest completed: v1.0.8 — 2026-07-17, release pending · last released: v1.0.7 — 2026-07-15)

Eight milestones released (v1.0.0, v1.0.1, v1.0.3 [incl. Spring Tide], v1.0.4, v1.0.5, v1.0.6, v1.0.7; v1.0.2 Ebb superseded); **v1.0.8 Phoenix Rising complete + archived 2026-07-17, public tag/release pending.** The two earliest are detailed below for reference; v1.0.2–v1.0.7 are archived under `.planning/milestones/`. The historical detail below is preserved as-is.
...
**Current focus:** **v1.0.8 Phoenix Rising complete + archived (2026-07-17).** All 6 phases (42–47) shipped and verified; PROOF-01 human-signed-off on a live 392-span five-level trace tree in a self-hosted Phoenix. The milestone is code-complete but **not yet released** — the public `v1.0.8` tag + images/OCI charts follow the rc-gated release process (bump chart/appVersion first, else the rc dry-run reuses prior published images → version skew). Next: run the release, then scope the next milestone — the LangGraph specialist-verify beachhead (vNext) and dynamic workflows at lifecycle seams are queued. The headline beyond remains full TIDE-on-TIDE.
...
---
*Last updated: 2026-07-17 after v1.0.8 Phoenix Rising milestone completion + archival (6 phases / 32 plans; PROOF-01 human-signed-off on a live 392-span five-level trace tree). Milestone complete; public tag/release (rc-gated) pending. Next: release v1.0.8, then scope the next milestone.*
