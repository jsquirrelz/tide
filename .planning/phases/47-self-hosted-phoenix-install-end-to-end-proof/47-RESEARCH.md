...
1. **Does D-08's auth-on "durable" recipe get its own OTLP-headers chart wiring in this phase, or does the live proof use the auth-off dev override?**
...
2. **Which storage-mode namespace name and PVC size does the planner lock in?**
